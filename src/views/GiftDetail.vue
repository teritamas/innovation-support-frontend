<template>
    <div class="content-center">
        ...
        <img class="rounded-t-sm img-box" src="@/assets/img/24857414_s.jpg" alt="product image" />
        <!--<img class="rounded-t-sm" :src="require(`@/assets/img/${img}`)" alt="product image" />-->
        <div class="bg-orange">
            <h3 class="font-bold text-center py-4">【初心者向け】のむちん先生とPythonで機械学習！</h3>
        </div>
        <div class="flex justify-around py-3">
            <span class="bg-gray text-blue-800 text-sm font-semibold rounded dark:bg-blue-200 dark:text-blue-800 mx-3">難易度: 低</span>
            <div class="inline">
        ...
        <div class="text-center">
            <span class="text-lg font-semibold text-gray-900">必要なトークン： 10000 pts</span>
            <button @click="purchaseGift()" class="text-center form-btn mb-3">購入する</button>
            <router-link to="/gift" class="text-center form-Return-btn mb-5">戻る</router-link>
        </div>
    </div>
</div>
