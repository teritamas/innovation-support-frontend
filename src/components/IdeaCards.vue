<template>
    ...
    <a href="#">
        <img class="rounded-t-lg" src="@/assets/img/ningyo.webp" alt="product image" />
    </a>
    <div class="pt-3 px-5 pb-5">
        <a href="#">
            ...
            <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">【アノテーション】雇用の機会を提供することによって社会問題の解決にも貢献する事業です。</h5>
        </a>
