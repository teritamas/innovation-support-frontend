    ...
    <div class="p-3 pt-0 mb-10 bg-white">
        <div class="Form mb-10">
            <div class="Form-Item">
                ...
                <input
                    type="text"
                    v-model="newProposion.businessName"
            ...
            <div class="Form-Item">
                ...
                <textarea
                    v-model="newProposion.businessSummary"
            ...
            <div class="Form-Item">
                ...
                <input
                    type="text"
                    v-model="newProposion.targetAmount"
                    class="Form-Item-Input"
                    placeholder="例）500万円"
                >
            </div>
            <div class="Form-Item">
                ...
                <label v-show="!newProposion.filePath" class="border file mt-2 input-item__label">ファイルを選択
                <input type="file" @change="onFileChange" />
                </label>
                <div class="preview-item w-100 mt-2">
                <embed
                    v-show="newProposion.filePath"
                    class="preview-item-file"
                    :src="newProposion.filePath"
                    alt=""
                />
                <div
                    v-show="newProposion.filePath"
                    ...
                    @click="remove"
                >
                    <p class="preview-item-name isMsg py-2">ファイル名：{{ newProposion.fileName }}</p>
                    <e-icon class="flex preview-item-icon isMsg border p-2 text-gray-600">
